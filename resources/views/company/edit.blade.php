...
<div class="text-right">
    <ul class="space-x-2 text-gray-500 text-xs font-mono">
        ...
        <li class="inline text-gray-400">Edit company</li>
    </ul>
</div>
<div class="bg-gray-50 py-4 rounded-md border px-8 pb-2 flex flex-col my-2">
    ...
    <h2 class="my-4 text-gray-800 text-2xl font-bold">Edit Company</h2>
    <hr class="mb-4">
    <form action="{{ route('company.update', $company->id) }}" method="POST" class="mx-4 mb-4">
        @csrf
        @method('put')
        <div class="-mx-8 md:flex mb-6">
            ...
            <div class="md:w-1/2 px-5">
                ...
                <input
                    ...
                    type="email" value="{{ $company->email }}" name="email">
                @error('email')
                <p class="mt-2 text-red-600 text-xs">{{ $message}}</p>
                @enderror
            </div>
        ...
        <div class="-mx-8 mb-6">
            <div class="w-full px-5 mb-6 md:mb-0">
                ...
                <input
                    ...
                    type="text" name="address" value="{{ $company->address }}">
                @error('address')
                <p class="mt-2 text-red-600 text-xs">{{ $message}}</p>
                @enderror
            </div>
