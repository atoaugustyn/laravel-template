...
<div class="text-right breadcrumb font-bold">
    <ul class="space-x-2 text-gray-500 text-xs">
        ...
        <li class="inline text-gray-400">Edit vessel</li>
    </ul>
</div>
<div class="bg-gray-50 py-4 rounded-md border px-8 pb-2 flex flex-col my-2">
    ...
    <h2 class="my-4 text-gray-800 text-2xl font-bold">Edit Vessel</h2>
    <hr class="mb-4">
    <form action="{{ route('vessel.update', $vessel->id ) }}" method="POST" class="mx-4 mb-4">
        @csrf
        @method('put')
        <div class="-mx-8 mb-6">
            <div class="w-full px-5 mb-6 md:mb-0">
                ...
                <input
                    ...
                    type="text" name="name" value="{{ $vessel->name }}">
                @error('name')
        ...
        <div class="-mx-8 md:flex mb-6">
            <div class="md:w-1/2 px-5 mb-6 md:mb-0">
                ...
                <input
                    ...
                    type="text" name="vessel_type" value="{{ $vessel->vessel_type }}">
                @error('vessel_type')
                <p class="mt-2 text-red-600 text-xs">{{ $message}}</p>
                @enderror
            </div>
            <div class="md:w-1/2 px-5 mb-6 md:mb-0">
                ...
                <input
                    ...
                    type="text" name="flag" value="{{ $vessel->flag }}">
                @error('flag')
                <p class="mt-2 text-red-600 text-xs">{{ $message}}</p>
                @enderror
            </div>
        ...
        <div class="-mx-8 md:flex mb-6">
            <div class="md:w-1/2 px-5 mb-6 md:mb-0">
                ...
                <input
                    ...
                    type="text" name="port_of_registration" value="{{ $vessel->port_of_registration }}">
            ...
            <div class="md:w-1/2 px-5 mb-6 md:mb-0">
                ...
                <input
                    ...
                    type="text" name="gross_tonnage" value="{{ $vessel->gross_tonnage }}">
                @error('gross_tonnage')
                <p class="mt-2 text-red-600 text-xs">{{ $message}}</p>
                @enderror
            </div>
        ...
        <div class="-mx-8 md:flex mb-6">
            <div class="md:w-1/2 px-5 mb-6 md:mb-0">
                ...
                <input
                    ...
                    type="text" name="call_sign" value="{{ $vessel->call_sign }}">
                @error('call_sign')
                <p class="mt-2 text-red-600 text-xs">{{ $message}}</p>
                @enderror
            </div>
            <div class="md:w-1/2 px-5 mb-6 md:mb-0">
                ...
                <input
                    ...
                    type="text" name="name_address_owner" value="{{ $vessel->name_address_owner }}">
