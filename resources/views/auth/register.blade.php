...
<body>
    <div class="flex flex-col items-center">
        <div class="w-full max-w-md mt-8 px-6 py-6 bg-gray-50 shadow-md rounded-md">
            <h2 class="text-gray-800 text-2xl font-bold">Register</h2>
            <hr class="my-2">
            <form action="{{ route('register') }}" method="POST">
                @csrf
                <div class="w-full mb-6 md:mb-0">
                    <label class="block text-gray-600 text-sm mb-2" for="name">Name</label>
                    <input
                ...
                <div class="w-full mt-4 mb-6 md:mb-0">
                    <label class="block text-gray-600 text-sm mb-2" for="password">Confirm password</label>
                    <input
